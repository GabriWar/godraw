...
func (w *window) updateOpaqueRegion() {
	if os.Getenv("GIO_TRANSPARENT") != "" {
		// Declare no opaque region so the compositor blends the surface's alpha
		// channel, enabling per-pixel transparency (godraw overlay patch).
